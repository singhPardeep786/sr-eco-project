    ...
    <div className="slides_main bg-zinc-800 relative">
      ...
      >
        {slides.map((slide, idx) => (
          <SwiperSlide key={idx} className="slides">
            <div className="content">
              <div className="banner_content">
                <div className="overflow-hidden">
                  <h5 className="uppercase">{slide.smallTitle}</h5>
                </div>
                <div className="overflow-hidden">
                  <h1>{slide.title}</h1>
                </div>
        ...
        <div className="swiper-button-prev"><Icon icon="line-md:arrow-down" width="24" height="24" style={{rotate:"180deg"}} />Icon 1</div>
        <div className="swiper-button-next"><Icon icon="line-md:arrow-down" width="24" height="24" style={{rotate:"180deg"}} />Icon 2</div>
      </Swiper> */}
      <Swiper
        pagination={{ clickable: true }}
        modules={[Autoplay, EffectFade, Navigation, Keyboard, Pagination]}
